...
export const StyledHalls = styled.div`
    width: 100%;
    height: 100%;
    display: grid;
...
export const StyledHallsHeading = styled.div`
    width: 100%;
    display: flex;
    flex-flow: column;
...
export const StyledHallsContent = styled.div`
    height: 100%;
    width: 100%;
    display: flex;
    flex-flow: column;
...
export const StyledHallsInner = styled.div`
    position: relative;
    width: 100%;
    height: 100%;
    display: flex;
...
export const StyledHallsGrid = styled.div`
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
